        ...
        <div class="row d-flex align-items-center flex-column-reverse flex-lg-row">
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="headerContent pt-5">
                    <h1>Sandals Shoes</h1>
                    <p>Sandals provide comfort, making them ideal for warm weather. Perfect for casual outings, the variety of designs ensures that you stay stylish while keeping your feet cool.</p>
                </div>
                <a href="#sandals" class="btn btn-dark">Explore</a>
            </div>
            <div class="col-lg-6 col-md-12 mb-1">
                <div class="homeImg mb-4 d-flex justify-content-center">
                    <img src="images/sandals3.png" alt="Sandals" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱950</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,079</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱999</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱899</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,400</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,199</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱599</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱559</b></h5>
                </div>
            </div>
        </div>
    </div>
