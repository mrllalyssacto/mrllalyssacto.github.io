    ...
    <div class="container mt-5">
        <div class="row d-flex align-items-center flex-column-reverse flex-lg-row">
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="headerContent pt-5">
                    <h1>Formal Shoes</h1>
                    <p>Classic and polished, formal shoes are designed for occasions that call for elegance. Whether for the office or a special event, they combine style and comfort for a sophisticated look</p>
                </div>
                <a href="#formal" class="btn btn-dark">Explore</a>
            </div>
            <div class="col-lg-6 col-md-12 mb-1">
                <div class="homeImg mb-4 d-flex justify-content-center">
                    <img src="images/formalModel.png" alt="Formal" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱594</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱699</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱694</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱399</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱589</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱3,299</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱3,999</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,799</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,100</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,299</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,783</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,155</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,364</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,217</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,527</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
