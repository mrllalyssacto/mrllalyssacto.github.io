        ...
        <div class="row d-flex align-items-center flex-column-reverse flex-lg-row">
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="headerContent pt-5">
                    <h1>Casual Shoes</h1>
                    <p>Everyday sneakers combine comfort and style, perfect for casual outings and daily wear. Versatile and easy to pair, they keep you comfortable all day long.</p>
                </div>
                <a href="#casual" class="btn btn-dark">Explore</a>
            </div>
            <div class="col-lg-6 col-md-12 mb-1">
                <div class="homeImg mb-4 d-flex justify-content-center">
                    <img src="images/casualModel.png" alt="Casual" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,199</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,899</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,299</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,099</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,366</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,992</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱3,554</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,045</b></h5>
                </div>
            </div>
        </div>
    </div>
