        ...
        <div class="row d-flex align-items-center flex-column-reverse flex-lg-row">
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="headerContent pt-5">
                    <h1>Sports Shoes</h1>
                    <p>Built for performance, sports shoes are made to enhance your athletic capabilities. They offer support, making them perfect for running, training, or sports activities.</p>
                </div>
                <a href="#sports" class="btn btn-dark">Explore</a>
            </div>
            <div class="col-lg-6 col-md-12 mb-1">
                <div class="homeImg mb-4 d-flex justify-content-center">
                    <img src="images/sports1.png" alt="Sports" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,200</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,999</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,999</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,699</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,399</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,499</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,900</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,760</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱3,160</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱1,960</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱2,668</b></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-4">
            <div class="card customCard">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><b>₱3,000</b></h5>
                </div>
            </div>
        </div>
    </div>
